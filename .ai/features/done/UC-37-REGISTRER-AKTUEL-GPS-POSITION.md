...
- [x] Backend kan modtage og validere latitude/longitude og tidspunkt.
- [x] Positionen knyttes til den autoriserede chauffør og ikke til et `driverId` leveret ukontrolleret i brugerens prompt.
- [x] Position anvendes kun, når nødvendigt lokationssamtykke findes.
- [x] Senest gyldige position kan hentes af andre Roadcue-funktioner.
- [x] Funktionen kan afgøre, om en position er for gammel til at være aktuel.
- [x] GPS-nøjagtighed kan indgå i vurderingen af, om data er egnet til præcis rutesammenligning.
- [x] Manglende GPS-data håndteres eksplicit og må ikke erstattes af LLM-gæt.
- [x] POC/test kan anvende simulerede koordinater.
- [x] Frontend- og backendtests mocker GPS-data og foretager ikke live OpenAI-kald.
