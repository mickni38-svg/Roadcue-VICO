...
6. Opdatér `.ai/features/03-USE-CASE-RELATIONS.md`, `.ai/features/04-IMPLEMENTATION-ORDER.md` eller `.ai/features/02-PRIORITIZED-ROADMAP.md`, hvis use casen ændrer disse forhold.
...
1. [Aktøren starter use casen.]
2. [VICO fortolker intention og relevant samtalekontekst.]
3. [VICO vælger om nødvendigt et godkendt tool.]
4. [Roadcue Backend autoriserer og udfører regler, opslag eller præcise beregninger.]
5. [En ekstern service eller communityet anvendes kun, hvis use casen kræver det.]
6. [VICO kombinerer de strukturerede resultater.]
7. [Chaufføren modtager et kort og forståeligt resultat.]
