...
- brugeren udtrykkeligt siger, at planen er godkendt, eller bevidst vælger `/continue` med tasken som aktiv/vedhæftet kontekst;
...
1. Læs `.ai/01-CONTRACT.md`, den aktive eller vedhæftede task, den linkede use case og kun relevante regler.
